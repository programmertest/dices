	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sInfo": "Mostrando _START_-_END_ de _TOTAL_ entradas", //"Showing _START_-_END_ of _TOTAL_ entries",
				"sInfoEmpty": "",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input id="catchText" type="text" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sId = (oSettings.sTableId === "") ? "" : 'id="'+oSettings.sTableId+'_rows"';
